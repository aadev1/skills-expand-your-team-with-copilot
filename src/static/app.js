document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    const shareWhatsapp = activityCard.querySelector(".share-whatsapp");
    ...
    shareCopy.addEventListener("click", () => {
      const iconSpan = shareCopy.querySelector(".share-icon");
      const tooltipSpan = shareCopy.querySelector(".tooltip-text");
      navigator.clipboard.writeText(shareText).then(() => {
        iconSpan.textContent = "✓";
        tooltipSpan.textContent = "Copied!";
        setTimeout(() => {
          iconSpan.textContent = "🔗";
          tooltipSpan.textContent = "Copy link";
        }, 2000);
      }).catch(() => {
        tooltipSpan.textContent = "Copy failed";
        setTimeout(() => {
          tooltipSpan.textContent = "Copy link";
        }, 2000);
      });
